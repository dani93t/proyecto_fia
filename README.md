...
En el proyecto realizado se usó un algorítmo propuesto por E. A. Zanaty, en donde agrega el número áureo (1.618033...) a la fófmula de la optimización por enjambre de particula (PSO).
